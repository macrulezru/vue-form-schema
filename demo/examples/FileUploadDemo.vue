  ...
  <div>
    <div class="page-header">
      ...
      <p>
        ...
        <code>fileSize</code>, <code>fileCount</code>. Supports single and multiple files with
        drag-and-drop.
      </p>
    </div>
...
:deep(.vfs-file-zone:hover) {
  border-color: var(--accent);
}
:deep(.vfs-file-zone--dragging) {
  border-color: var(--accent);
  background: rgba(109, 106, 254, 0.06);
}
:deep(.vfs-file-input) {
  position: absolute;
  inset: 0;
