      ...
      h('div', { style: 'margin-bottom:16px' }, [
        props.field.label
          ? h(
              ...
              {
                style:
                  'font-size:0.8rem;font-weight:500;color:var(--muted);text-transform:uppercase;letter-spacing:0.04em;margin-bottom:8px',
              },
              props.field.label,
            )
          : null,
...
provideRegistry({ checkbox: PillToggle })</pre
    ...
    <div class="card">
      ...
      <p style="font-size: 0.82rem; color: var(--muted); margin-bottom: 16px">
        Pass <code>component: MyComponent</code> directly on a field definition to override the
        registry for that specific field only.
      </p>
