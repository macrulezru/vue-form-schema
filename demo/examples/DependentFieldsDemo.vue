...
<template>
  <div>
    <div class="page-header">
      ...
      <p>
        Options can be a sync function, async function (with <code>optionsDeps</code>), or
        <code>defaultValue</code> can be a function that reads other field values.
      </p>
    </div>
    ...
    <div class="card">
      ...
      <p style="font-size: 0.82rem; color: var(--muted); margin-bottom: 16px">
        The <code>country</code> options function fires on every values change. The
        <code>city</code> field is hidden until a country is selected.
      </p>
    ...
    <div class="card">
      ...
      <p style="font-size: 0.82rem; color: var(--muted); margin-bottom: 16px">
        <code>options</code> returns a <code>Promise</code>. Set
        <code>optionsDeps: ['category']</code>
    ...
    <div class="card">
      ...
      <p style="font-size: 0.82rem; color: var(--muted); margin-bottom: 16px">
        <code>defaultValue: (values) =&gt; ...</code> is evaluated at form init with
        already-resolved defaults as context.
      </p>
